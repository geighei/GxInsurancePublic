...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{../3_output/shock_effects/main_6070_100_cvplot.png}
...
\begin{figure}[ht]
	\begin{center}
		...
		{\includegraphics[width=0.3\textwidth]
		{../3_output/shock_effects/edu_6070_100_cvplot.png}
		}
		\subfigure[\textsf{Cognitive Skills}]
		{\includegraphics[width=0.3\textwidth]
		{../3_output/shock_effects/cog_6070_100_cvplot.png}
		}
		\subfigure[\textsf{Risk Aversion}]
		{\includegraphics[width=0.3\textwidth]
		{../3_output/shock_effects/risk_6070_100_cvplot.png}
		}
		\subfigure[\textsf{Conscientiousness (Big-5)}]
		{\includegraphics[width=0.3\textwidth]
		{../3_output/shock_effects/consc_6070_100_cvplot.png}
		}
		...
		{\includegraphics[width=0.3\textwidth]
		{../3_output/shock_effects/inc_6070_100_cvplot.png}
		}
		%
...
\begin{figure}[ht]
	\begin{center}
		...
		{../3_output/shock_effects/IHSwage_6070_100_cvplot.png}
		}
		\subfigure[\textsf{Total Household Income (IHS)}]
		{\includegraphics[width=0.22\textwidth]
		{../3_output/shock_effects/IHShitot_noout_6070_100_cvplot.png}
		}
%		\subfigure[\textsf{Wealth (IHS)}]
%		{\includegraphics[width=0.22\textwidth]
%		{../3_output/shock_effects/IHSwealth_6070_100_cvplot.png}
%		}
		\subfigure[\textsf{Probability of Retiring}]
		{\includegraphics[width=0.22\textwidth]
		{../3_output/shock_effects/retired_6070_100_cvplot.png}
		}
		\subfigure[\textsf{Relationship status}]
		{\includegraphics[width=0.22\textwidth]
		{../3_output/shock_effects/mpart_6070_100_cvplot.png}
		}
		\subfigure[\textsf{Medical expenditure}]
		{\includegraphics[width=0.22\textwidth]
		{../3_output/shock_effects/medexp_6070_100_cvplot.png}
		}
		\subfigure[\textsf{2 Year Mortality}]
		{\includegraphics[width=0.22\textwidth]
		{../3_output/shock_effects/dead2_6070_100_cvplot.png}
		}
		\subfigure[\textsf{5 Year Mortality}]
		{\includegraphics[width=0.22\textwidth]
		{../3_output/shock_effects/dead5_6070_100_cvplot.png}
		}
