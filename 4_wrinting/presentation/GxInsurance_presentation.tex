...
%\begin{frame}
%\frametitle{Raw data}
%If always uninsured: diff in cessation rates after health-shock
%%by:
%%\begin{itemize}
%%	\item High vs. low PGS
%%	\item Pre vs. post 65 / free insurance
%%\end{itemize}
%
%\begin{figure}[hbtp]
...
%\includegraphics[height=0.8\textheight]{../../3_output/cess_rates_graph/graph_6070_TAGpgsplot2.png}
%\label{fig:rawcessation}
%\end{figure}
%
%\hyperlink{frame:sumstats}{\beamergotobutton{Sumstats1}}
%\hyperlink{frame:sumstats2}{\beamergotobutton{Sumstats2}}
%\end{frame}
...
%\caption{Raw cessation rate by group}
\centering
%\includegraphics[height=0.8\textheight]{../../3_output/shock_effects/main_6070_100_cvinverse_plot.png}
...
%\caption{Raw cessation rate by group}
%\centering
%\includegraphics[height=0.8\textheight]{table4.png}
%\label{tab:maincoeff}
%\end{figure}
...
\begin{table}[ht]
	...
	\small\resizebox{1.3\textheight}{!}{
		\input{../../3_output/descriptive/descriptive_uninsured.tex}
	}
\end{table}
...
%%\caption{Raw cessation rate by group}
%\centering
%\includegraphics[height=0.8\textheight]{../../3_output/shock_effects/robustness_5773_100_cvplot.png}
...
%%\caption{Raw cessation rate by group}
%\centering
%\includegraphics[height=0.8\textheight]{../../3_output/shock_effects/robustness_5674_100_cvplot.png}
...
%%\caption{Raw cessation rate by group}
%\centering
%\includegraphics[height=0.8\textheight]{../../3_output/shock_effects/robustness_6070_100_cv_25pplot.png}
%\label{fig:coeffplot25highPGS}
%\end{figure}
%\hyperlink{frame:robustness}{\beamergotobutton{back}}
%\end{frame}
...
%%\caption{Raw cessation rate by group}
%\centering
%\includegraphics[height=0.8\textheight]{../../3_output/shock_effects/wage_6070_100_cvplot.png}
%\label{fig:wage}
%\end{figure}
%\hyperlink{frame:robustness}{\beamergotobutton{back}}
%\end{frame}
